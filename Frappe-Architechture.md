...
![frappe-architecture](https://user-images.githubusercontent.com/328330/221419567-15661be9-02f3-4906-a6fe-b23704d97cb0.png)

*Architecture*

To setup a Frappe based site, you need to first install Bench. If you haven't
installed it already, check out the [Installation](/docs/v14/user/en/installation)
page.
